import unittest
from solution import SinglyLinkedList as SLL, show_encrypted
...
class MyTestCase(unittest.TestCase):
    ...
    def test_to_string(self):
        ...
        # If you're failing here, make sure you're account for types other than strings!
        sll.push(3)
    ...
    def test_remove_all(self):
        ...
        # 1. Removing from an empty list
        self.assertEqual(False, sll.remove_all(331))  # SLL: Empty
        self.assertIs(None, sll.head)  # 1
        self.assertIs(None, sll.tail)  # 1
    ...
    def test_count(self):
        ...
        # 4. Get the number of 0's from the multi-element list
        sll.push(0)
        sll.push(0)
    ...
    def test_show_encrypted(self):
        ...
        sll.push('Arthur')
        show_encrypted(sll)
        self.assertEqual('Arthur', sll.head.val)  # 2
        self.assertIs(None, sll.head.next)  # 2
        self.assertEqual('Arthur', sll.tail.val)  # 2
        ...
        sll.push('Zaphod')
        show_encrypted(sll)
        self.assertEqual('Zaphod', sll.head.val)  # 3
        self.assertEqual('Beeblebrox', sll.head.next.val)  # 3
        self.assertIs(None, sll.head.next.next)  # 3
        self.assertEqual('Beeblebrox', sll.tail.val)  # 3
        self.assertIs(sll.head.next, sll.tail)  # 3

        # 4. Reverse a three element list
        sll = SLL()
        sll.push('Drive')
        sll.push('Improbability')
        sll.push('Infinite')
        show_encrypted(sll)
        self.assertEqual('Infinite', sll.head.val)  # 4
        self.assertEqual('Improbability', sll.head.next.val)  # 4
        self.assertEqual('Drive', sll.head.next.next.val)  # 4
        self.assertIs(None, sll.head.next.next.next)  # 4
        self.assertEqual('Drive', sll.tail.val)  # 4
        ...
        sll.push('a')
        show_encrypted(sll)
        self.assertEqual('a', sll.head.val)  # 5
        self.assertEqual('bowl', sll.head.next.val)  # 5
        self.assertEqual('of', sll.head.next.next.val)  # 5
        self.assertEqual('petunias', sll.head.next.next.next.val)  # 5
        self.assertIs(None, sll.head.next.next.next.next)  # 5
        self.assertEqual('petunias', sll.tail.val)  # 5
        ...
        sll.push('Vogon')
        show_encrypted(sll)
        self.assertEqual('Vogon', sll.head.val)  # 6
        self.assertEqual('poetry', sll.head.next.val)  # 6
        self.assertEqual('is', sll.head.next.next.val)  # 6
        self.assertEqual('the', sll.head.next.next.next.val)  # 6
        self.assertEqual('third', sll.head.next.next.next.next.val)  # 6
        self.assertEqual('worst', sll.head.next.next.next.next.next.val)  # 6
        self.assertEqual('in', sll.head.next.next.next.next.next.next.val)  # 6
        self.assertEqual('the', sll.head.next.next.next.next.next.next.next.val)  # 6
        self.assertEqual('Universe', sll.head.next.next.next.next.next.next.next.next.val)  # 6
        self.assertIs(None, sll.head.next.next.next.next.next.next.next.next.next)  # 6
        self.assertEqual('Universe', sll.tail.val)  # 6
        self.assertIs(sll.head.next.next.next.next.next.next.next.next, sll.tail)  # 6
