...
from solution import HashTable, HashNode, display_duplicates, generate_fan_chant
...
class TestProject1(unittest.TestCase):
    ...
    def test_insert(self):
        ...
        # inserting into already inserted before
        ...
        # inserting into deleted (not requiring delete to work)
        table.table[10].key = None
        table.table[10].value = None
        table.table[10].deleted = True
        table.size -= 1
    ...
    def test_get(self):
        ...
        # Check if _hash function checks for deleted
        table.table[-2].key = None
        table.table[-2].value = None
        table.table[-2].deleted = True
